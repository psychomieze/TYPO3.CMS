...
class TypoScriptDebugWaterfall implements AdminPanelSubModuleInterface
{
    ...
    public function getContent(): string
    {
        ...
        $templateNameAndPath = $this->extResources . '/Templates/Modules/TsDebug/TypoScriptDebugWaterfall.html';
    ...
    {
        return 'typoscript-dummy-waterfall';
    }
    ...
    public function initializeModule(ServerRequest $request): void
    {
        ...
        $typoScriptFrontend->forceTemplateParsing = (bool)$this->configurationService->getConfigurationOption(
            'tsdebug',
